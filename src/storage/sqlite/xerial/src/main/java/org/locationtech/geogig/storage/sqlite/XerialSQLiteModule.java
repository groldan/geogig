...
public class XerialSQLiteModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(ObjectDatabase.class).to(XerialObjectDatabaseV2.class).in(Scopes.SINGLETON);
        bind(GraphDatabase.class).to(XerialGraphDatabaseV2.class).in(Scopes.SINGLETON);
    }
