...
public abstract class ObjectDatabaseStressTest {
    ...
    public void testPutAll_1M () throws Exception {
        // use Assume instead of @Ignore. If the "runLargeDbTests" profile is not activated, Assume
        // will skip this test. The "runLargeTests" profile will also activate runLargeDbTests.
