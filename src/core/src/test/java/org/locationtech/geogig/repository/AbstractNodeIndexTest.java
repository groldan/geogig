...
public abstract class AbstractNodeIndexTest extends Assert {
    ...
    public void test5M() throws Exception {
        // use Assume instead of @Ignore. If the "runLargeNodeTests" profile is not activated, Assume
        // will skip this test. The "runLargeTests" profile will also activate runLargeNodeTests.
