...
public abstract class PointCacheTest extends Assert {
    ...
    public void testLargeSequences10M() {
        // use Assume instead of @Ignore. If the "cacheStressTests" profile is not activated, Assume
        // will skip this test. The "stressTests" profile will also activate cacheStressTests.
