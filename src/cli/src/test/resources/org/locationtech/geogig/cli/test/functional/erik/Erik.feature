Feature: "add" command
  ...
  Scenario: Try to add a conflicted feature
    Given I have a repository
     ...
     Then the response should contain "CONFLICT: Merge conflict in Points/Points.1Automatic merge failed. Fix conflicts and then commit the result.. See the log for more details."
